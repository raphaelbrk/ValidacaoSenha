...
namespace Validacao.Senha.Application.Handler
{
    ...
    internal class GravacaoSenhaHandler : IRequestHandler<GravacaoSenhaCommand, Guid>
    {
        ...
        public async Task<Guid> Handle(GravacaoSenhaCommand request, CancellationToken cancellationToken)
        {
